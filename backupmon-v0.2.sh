...
USERNAME="admin"
PASSWORD="admin"
UNC="\\\\192.168.86.9\\Backups"
UNCDRIVE="/tmp/mnt/jangofett"
...
backup() {
  ...
  if [ -n "`mount | grep $UNCDRIVE`" ]; then
      ...
      { echo 'RESTORE INSTRUCTIONS'
        ...
        echo '3.) Restore the backup.sh script (located under your backup folder) into your /jffs/scripts folder.'
        echo '4.) Ensure that all of the settings/variables are correct before running a restore!'
