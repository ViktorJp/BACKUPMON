...
# BACKUPMON v1.5.2b1 heavily modified and restore functionality added by @Viktor Jaep, 2023
#
...
Version="1.5.2b1"                                               # Current version
            ...
            14) # -----------------------------------------------------------------------------------------
              ...
              if [ "$AMTMEMAIL" == "1" ]; then
                ...
                if promptyn "(y/n): "; then
                  ...
                  printf " is working well from BACKUPMON.\n"
                  } > "$tmpEMailBodyFile"
