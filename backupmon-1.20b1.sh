...
# BACKUPMON v1.20b1 heavily modified and restore functionality added by @Viktor Jaep, 2023
#
...
Version=1.20b1                                                  # Current version
...
vsetup () {
  ...
  while true; do
    ...
    logoNM
    echo ""
    echo -e "${CYellow}Setup + Operations Utility${CClear}" # Provide main setup menu
    echo ""
    echo -e "${CGreen}----------------------------------------------------------------"
